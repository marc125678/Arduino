 ...
 * 
 * Al pulsar el botón comienza a encender los leds. Si se mantiene pulsado igualmente se siguen encendiendo
 * 
 * Esta version está refactorizado para utilizar funciones separadas y hacer más legible el código
 * 
 *
*/
